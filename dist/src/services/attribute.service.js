...
const bulkdeleteAttribute = (id) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    return attribute_1.default.deleteMany({ _id: id });
});
exports.default = { getAttributes, getAttribute, createAttribute, updateAttribute, deleteAttribute, bulkdeleteAttribute };
