    ...
    Mutation: {
        createPost: graphql_resolvers_1.combineResolvers(middlewares_1.isAuthenticated, (_, { input }, { email, loggedInUserId, esClient }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                let esResult = yield posts_1.createesPost(esClient, response);
        ...
        bulkdeletePost: graphql_resolvers_1.combineResolvers(middlewares_1.isAuthenticated, (_, { id }, { email }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            try {
                return yield post_service_1.default.bulkdeletePost(id);
            }
            catch (ex) {
                return ex;
            }
