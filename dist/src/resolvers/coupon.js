...
exports.default = {
    ...
    Mutation: {
        ...
        bulkdeleteCoupon: graphql_resolvers_1.combineResolvers(middlewares_1.isAuthenticated, (_, { id }, { email }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
            return coupon_service_1.default.bulkdeleteCoupon(id);
        }))
    }
};
